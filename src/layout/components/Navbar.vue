  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      <template v-if="getters.device !== 'mobile'">
        ...
        <el-tooltip content="可视化平台" effect="dark" placement="bottom">
          <router-link to="/cockpit" target="_blank">
            <div class="right-menu-item hover-effect">可视化平台</div>
          </router-link>
        </el-tooltip>

        <el-tooltip content="服务发布" effect="dark" placement="bottom">
          <router-link to="/geoserver/geoserver/web/?0" target="_blank">
            <div class="right-menu-item hover-effect">服务发布</div>
          </router-link>
        </el-tooltip>
