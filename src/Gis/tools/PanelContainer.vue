<template>
  <div class="xt-panel" v-show="visible">
    <div class="xt-panel-title" @mousedown="move">
      {{title}}
      <div class="xt-panel-close" @click="close">×</div>
      <div class="xt-panel-miniaturized" @click="miniaturized">-</div>
    </div>
    <div class="xt-panel-content">
