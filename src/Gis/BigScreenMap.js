...
export default class BigScreenMap extends mix(
    ...
    addLandmark() {
        ...
        this.createModel(dataSource, '/static/model/zhui.glb', coordinate, '空间信息');
            ...
            if (this.pickedType === '建筑') {
                ...
                if (pickedObject) {
                    ...
                    if (pickedObject.primitive.name === 'monomer') {
                        ...
                        this.pickedPosition = {
                            id: pickedObject.getProperty("id"),
                            x: pickedObject.getProperty("X"),
                            y: pickedObject.getProperty("Y"),
                            z: pickedObject.getProperty("height")
                        };
                        window.parent.postMessage(this.pickedPosition, "*");
                    }
                }
